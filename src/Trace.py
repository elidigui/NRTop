...
class NonReg:
    ...
    def RunNonRegDir(self,list_d):
        ...
        #Instantiate CompRep:
        print("Directories %s and %s are compared:"%(list_d[0],list_d[1]))
...
class ConvToCsv():
    ...
    def plt_to_csv(self,f):
        """Convert a Tecplot 2D datafile into a basic 1 header csv file"""
